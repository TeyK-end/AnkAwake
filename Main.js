...
document.addEventListener("click", (event) => {
  if (!popUnderOpened && !event.target.closest("a, button, .popup-ad, .floating-ad")) {
    const popUnder = window.open("https://www.dienmayxanh.com/may-lanh?utm_source=A8WKOm1Ng&click_id=zKEfFlztH2ABuyJLMJG2KUzQX4HD8_DIuFExQdl4LIM&gad_source=1&gad_campaignid=22253923118&gbraid=0AAAAA-dRZ4ojIw_bfAZrrzW7Mf2Z9wW0M&gclid=Cj0KCQjwm93DBhD_ARIsADR_DjHrZO8pplQL7rFKEWsyO6m-LHibFZhzqtOygaZk3xv-Hj4TTnw0h6QaAn6xEALw_wcB");
    if (popUnder) {
      popUnder.blur();
      window.focus();
      popUnderOpened = true;
